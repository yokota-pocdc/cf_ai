...
const insert = db.prepare(
  'INSERT INTO transactions (date, amount, description, category, subcategory, chat_context) VALUES (?, ?, ?, ?, ?, ?)'
);
...
for (const tx of allTx) {
  insert.run(tx.date, tx.amount, tx.description, tx.category, tx.subcategory, tx.context);
}
